...
//        a = configDetails.getMode(); .// prompt user for mode... either return trainingDao or productionDao
//        
//        VendingMachineDao dao1 = 
//           ctx.getBean("a", VendingMachineDao.class);
//        
//        this.service = (dao1, this.view);
